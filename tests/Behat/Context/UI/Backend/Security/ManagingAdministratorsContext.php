...
namespace App\Tests\Behat\Context\UI\Backend\Security;

use function App\Tests\Behat\Context\UI\Backend\sprintf;
use App\Tests\Behat\Element\Backend\TopBarElement;
use App\Tests\Behat\Page\Backend\Security\CreatePage;
use App\Tests\Behat\Page\Backend\Security\IndexPage;
use App\Tests\Behat\Page\Backend\Security\UpdatePage;
...
final class ManagingAdministratorsContext implements Context
{
    public function __construct(
        ...
        private readonly TopBarElement $topBarElement,
